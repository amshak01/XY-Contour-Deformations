...
\usepackage{makecell} % put this in your preamble
...
\begin{figure}
	\begin{center}
	\include{figures/contour1_cartoon}
	\end{center}
...
\begin{figure}[h]
	\begin{center}
	\include{figures/transpose_conv2d}
	\end{center}
...
\begin{figure}[h]
	...
	\begin{minipage}{0.1\textwidth}
		...
		\begin{tikzpicture}[scale=1]
			...
			\node[above] at (0,0.4) {\footnotesize Network};
		\end{tikzpicture}
	\end{minipage}
	\hspace{0.05\textwidth}
	\begin{minipage}{0.3\textwidth}
...
\begin{table}[h!]
\centering
\renewcommand{\arraystretch}{1.6} % extra vertical space above/below rows
\small
...
\begin{figure}[htp]
	\centering
	\foreach \i in {0,...,\numexpr\Nrows-1} {%
		\includegraphics[width=0.8\textwidth]{figures/1layer_hists/temp_\i.png}
	}
...
\begin{figure}[htp]
	\centering
	\foreach \i in {0,...,\numexpr\Nrows-1} {%
		\includegraphics[width=0.8\textwidth]{figures/unet_hists/temp_\i.png}
	}
...
\begin{figure}[h!]
	\centering
	\foreach \i in {0,...,2} {%
		\includegraphics[width=0.9\textwidth]{figures/deformed_vs_undeformed/fig_\i.png}
	}
...
\begin{figure}[h!]
	\centering
	\foreach \i in {0,...,4} {%
		\includegraphics[width=0.495\textwidth]{figures/deformed_vs_undeformed_var/fig_\i.png}
	}
